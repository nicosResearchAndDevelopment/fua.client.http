...
/** @typedef {{keepAlive?: boolean | null, keepAliveInitialDelay?: number | null, socketPath?: string | null, maxCachedSessions?: number | null, timeout?: number | null, servername?: string, enableTrace?: boolean, rejectUnauthorized?: boolean, minDHSize?: number, highWaterMark?: number, ca?: string | Array<string> | Buffer | Array<Buffer>, cert?: string | Array<string> | Buffer | Array<Buffer>, sigalgs?: string, ciphers?: string, clientCertEngine?: string, crl?: string | Array<string> | Buffer | Array<Buffer>, dhparam?: string | Buffer, ecdhCurve?: string, honorCipherOrder?: boolean, key?: string | Array<string> | Buffer | Array<Buffer>, privateKeyEngine?: string, privateKeyIdentifier?: string, maxVersion?: string, minVersion?: string, passphrase?: string, pfx?: string | Array<string> | Buffer | Array<Buffer> | { buf: string | Buffer, passphrase: string }, secureOptions?: number, secureProtocol?: string, sessionIdContext?: string, sessionTimeout?: number}} RequestConnectOptions */
